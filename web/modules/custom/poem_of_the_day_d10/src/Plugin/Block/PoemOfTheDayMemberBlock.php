...
/**
 * Provides a 'Poem of the Day: Member' Block.
 *
 * @Block(
 *   id = "potd_m",
 *   admin_label = @Translation("Poem Of The Day: Member")
 * )
 */
class PoemOfTheDayMemberBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() : array {
    $values = $this->service->getPoemValues('member_poem');
    if (!$values) {
      return ['#markup' => ''];
    }
